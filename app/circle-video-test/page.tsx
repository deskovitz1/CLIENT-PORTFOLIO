...
export default function CircleVideoTestPage() {
  ...
  const fetchVideos = async () => {
    try {
      ...
      console.log("Circle test videos loaded:", allVideos.length, "videos (after filtering hidden)");
      setVideos(allVideos);
    } catch (err) {
